...
public:
    ...
    // control the setting of vertices and normals of each version of earth
    void morph(float a);
    Vector3 NormalToSphere(double latitude, double longitude) const;
    //vertices and normal for plane mesh
    std::vector<Point3> vertices_plane;
    std::vector<Vector3> normals_plane;
   
    //vertices and normal for sphere mesh
    std::vector<Point3> vertices_sphere;
    std::vector<Vector3> normals_sphere;
